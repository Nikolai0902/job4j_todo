...
public class SimpleTaskStore implements TaskStore {
    ...
    public Optional<Task> findById(int id) {
        return crudRepository.optional("FROM Task f JOIN FETCH f.priority "
                + "JOIN FETCH f.category "
                + "WHERE f.id = :id", Task.class, Map.of("id", id));
    }
    ...
    public List<Task> findAllOrderById() {
        return crudRepository.query("FROM Task f JOIN FETCH f.priority "
                + "JOIN FETCH f.category "
    ...
    public List<Task> findAllDoneTrueOrFalse(boolean flag) {
        return crudRepository.query("FROM Task f JOIN FETCH f.priority "
                + "JOIN FETCH f.category "
                + "WHERE f.done = :done", Task.class, Map.of("done", flag));
    }
}
